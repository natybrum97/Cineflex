...
export default function SeatsPage(props) {
    ...
    const { objeto2, setObjeto2, objeto3, setObjeto3, objeto4, setObjeto4, name, setName, cpf, setCpf, cadeirasSelectNumero, setCadeirasSelectNumero, cadeirasSelect, setCadeirasSelect} = props;
